...
create_featuring_network <- function(x) {
  ...
  nodes_table$Id<-str_replace_all(nodes$Id,"\\s","-")
  edges_table$Source<-as.character(edges$Source)
  edges_table$Target<-as.character(edges$Target)
  edges_table$Source<-str_replace_all(edges$Source,"\\s","-")
  edges_table$Target<-str_replace_all(edges$Target,"\\s","-")
